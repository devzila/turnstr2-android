...
public class RegistrationApiService implements Callback<LoginResDataModal> {
    ...
    public void Connect(String name, String email, String username, String password, String device_id, String device_token, ApiResponseListner apiResponseListner) {
        this.apiResponseListner = apiResponseListner;
        Call<LoginResDataModal> call = apiInterface.signup(name,email,username,password,device_id,device_token);
        call.enqueue(this);
        setProgressDialog();
    }
    ...
    public void onResponse(Call<LoginResDataModal> call, Response<LoginResDataModal> response) {
        ...
        if (loginResDataModal != null) {
            if (loginResDataModal.isSuccess().equalsIgnoreCase("true")) {
                ...
                apiResponseListner.onSuccess(ApiConstants.signup_tag, superCastClass);
            } else {
