...
public class LoginApiService implements Callback<LoginResDataModal> {
    ...
    public void Connect(String email,  String password, String device_id, String device_token, ApiResponseListner apiResponseListner) {
        this.apiResponseListner = apiResponseListner;
        Call<LoginResDataModal> call = apiInterface.login(email,password,device_id,device_token);
        call.enqueue(this);
        setProgressDialog();
    }
