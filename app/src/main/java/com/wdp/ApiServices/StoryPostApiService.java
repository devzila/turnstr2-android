...
public class StoryPostApiService implements Callback<CommanDataModal> {
    private APIInterface apiInterface;
    private ApiResponseListner apiResponseListner;
    private GoogleProgressDialog progressDialog;
    private Context context;

    public StoryPostApiService(Context context) {
    ...
    public void Connect(CreateStroyRequest_model stroyRequest_model, String header, ApiResponseListner apiResponseListner) {
        this.apiResponseListner = apiResponseListner;
        Call<CommanDataModal> call = apiInterface.meCreateStories(stroyRequest_model,header);
        call.enqueue(this);
        setProgressDialog();
    }
    ...
    public void onResponse(Call<CommanDataModal> call, Response<CommanDataModal> response) {
        ...
        if (commanDataModal != null) {
            if (commanDataModal.getSuccess().equalsIgnoreCase("true")) {
                ...
                apiResponseListner.onSuccess(ApiConstants.StoryPost_TAG, superCastClass);
            } else {
