...
public class FollowUnfollowiService implements Callback<CommanDataModal> {
    private APIInterface apiInterface;
    private ApiResponseListner apiResponseListner;
    private GoogleProgressDialog progressDialog;
    private Context context;

    public FollowUnfollowiService(Context context) {
    ...
    public void Connect(String header,String url, ApiResponseListner apiResponseListner) {
        ...
        Call<CommanDataModal> call = apiInterface.getFollow(header,url);
        call.enqueue(this);
        setProgressDialog();
    }

    public void Connect1(String header,String url, ApiResponseListner apiResponseListner) {
        this.apiResponseListner = apiResponseListner;
        Call<CommanDataModal> call = apiInterface.geUnFollow(header,url);
        call.enqueue(this);
        setProgressDialog();
    }
    ...
    public void onResponse(Call<CommanDataModal> call, Response<CommanDataModal> response) {
        ...
        if (commanDataModal != null) {
            if (commanDataModal.getSuccess().equalsIgnoreCase("true")) {
                ...
                apiResponseListner.onSuccess(ApiConstants.FollowUnFollow_TAG, superCastClass);
            } else {
