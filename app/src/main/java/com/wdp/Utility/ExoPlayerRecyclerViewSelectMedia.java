...
import com.wdp.Adapter.SelectImageAdapterViewHolder;
import com.wdp.turnstr.R;

import java.util.ArrayList;
import java.util.Objects;

public class ExoPlayerRecyclerViewSelectMedia extends RecyclerView  {
    ...
    public OnSelectPositon onSelectPositon;

    public interface OnSelectPositon{
        public void  onselectPositon(int position);
    }

    public void setListener(OnSelectPositon listener) {
        this.onSelectPositon = listener;
    }
    /**
    ...
    public ExoPlayerRecyclerViewSelectMedia(@NonNull Context context) {
        super(context);
        init(context);
    }

    public ExoPlayerRecyclerViewSelectMedia(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ExoPlayerRecyclerViewSelectMedia(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if (!isEndOfList) {
            ...
            targetPosition = dataList.size() - 1;
        }
         onSelectPositon.onselectPositon(targetPosition);
        ...
        SelectImageAdapterViewHolder holder = (SelectImageAdapterViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        ...
        String mediaUrl="";
        if (dataList.size() > 0){
            mediaUrl =  dataList.get(targetPosition);
        }
    ...
    private void animateVolumeControl() {
        if (volumeControl != null) {
            ...
            if (volumeState == VolumeState.OFF) {
                requestManager.load(R.drawable.mute)
                        .into(volumeControl);
                videoPlayer.setPlayWhenReady(true);
            } else if (volumeState == VolumeState.ON) {
    ...
    public void setMediaObjects(ArrayList<String> dataList,OnSelectPositon onSelectpositon) {
