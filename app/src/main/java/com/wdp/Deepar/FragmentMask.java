...
public class FragmentMask extends PermissionsActivity implements AREventListener, SurfaceHolder.Callback,
   ...
   private int getScreenOrientation() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        deepAR.setLicenseKey("f26363873bfcd1cf205dd7c129d2915b201b59f6930902c6db742c73d0bbf1d246900cf7e1b81224");
        deepAR.initialize(getActivity(), this);
        rl_fillter =  view.findViewById(R.id.rl_fillter);
        relativeLayout =  view.findViewById(R.id.relativeLayout);
        radioTabgroup = view.findViewById(R.id.radioTabgroup);
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.radioHeader1:
                        setupEffects();
                        maskFilterationListAdapter.notifyDataSetChanged();
    ...
    private void setupEffects2() {
        ...
        masks.add(new AREffect("look4",AREffect.EffectTypeMask,R.drawable.look4_));
        masks.add(new AREffect("look5",AREffect.EffectTypeMask,R.drawable.look5_));
   }
   ...
   private void setupDeepAR() {
    ...
    private void setupViews() {
        ...
        setupEffects();
        imgAvtar = (RoundedImageView) view.findViewById(R.id.imgAvtar);

        imgAvtar.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void screenshotTaken(final Bitmap screenshot) {
        ...
        try {
            ...
            Toast.makeText(getActivity(), getResources().getString(R.string.photo_successfully_save), Toast.LENGTH_LONG).show();
    ...
    public void videoRecordingStarted() {
        Toast.makeText(getActivity(), getResources().getString(R.string.Video_Starting), Toast.LENGTH_LONG).show();
    }
