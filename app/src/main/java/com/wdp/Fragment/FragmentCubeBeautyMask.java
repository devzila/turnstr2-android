...
public class FragmentCubeBeautyMask extends PermissionsActivity implements AREventListener, SurfaceHolder.Callback,
    ...
    public FragmentCubeBeautyMask(){

    }

    public FragmentCubeBeautyMask(String whichscreen){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txt_live.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                commonSharedPreference.setLiveType(getActivity(),"Broadcaster");
