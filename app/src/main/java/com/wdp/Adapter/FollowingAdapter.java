...
public class FollowingAdapter extends RecyclerView.Adapter<FollowingAdapter.MyViewHolder>{
    ...
    public interface onClickFollowing {
        public void onclickFollowing(String pos,String id);
    }

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView txt_name;
        public Button btn_approve;
        public LinearLayout ll_cube;
        public CubeGLSurfaceView glView;
    ...
    public FollowingAdapter(Context context,List<FollowingBean> dataList,onClickFollowing onClickFollowing) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.btn_approve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onClickFollowing != null){
                    onClickFollowing.onclickFollowing(holder.btn_approve.getText().toString(),current.getId());
                }
