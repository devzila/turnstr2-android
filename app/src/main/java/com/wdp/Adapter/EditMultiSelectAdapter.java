...
public class EditMultiSelectAdapter extends RecyclerView.Adapter<EditMultiSelectAdapter.MyViewHolder>
         implements ItemTouchHelperAdapter {

    private List<MyPostDataModal.DataBean.PostsBean.MediaProfileBean> posts;
    ...
    public EditMultiSelectAdapter(Activity context, ArrayList<MyPostDataModal.DataBean.PostsBean.MediaProfileBean> datalist, onClickApprove clickApprove, OnStartDragListener dragStartListener) {
