//package com.adroidtech.turnstr2.imageFillters;
//
...
//
//import static com.zomato.photofilters.SampleFilters.*;
//
//public class ImageFillterSettingActivity extends AppCompatActivity implements ThumbnailCallback {
//    static {
...
//        placeHolderImageView.setImageBitmap(BitmapFactory.decodeResource(this.getApplicationContext().getResources(), R.drawable.photo));
//        initHorizontalList();
//    }
//
