...
public class TestRender implements GLTextureView.Renderer {
...
//	float touchedY = 0;
     ...
     */
    public TestRender(ArrayList<Bitmap> allBitmaps) {
...
//            loadImageFromServer();
            ...
            mTextureDataHandle0 = loadTexture(allBitmaps.get(0));
            mTextureDataHandle1 = loadTexture(allBitmaps.get(1));
            mTextureDataHandle2 = loadTexture(allBitmaps.get(2));
            mTextureDataHandle3 = loadTexture(allBitmaps.get(3));
            mTextureDataHandle4 = loadTexture(allBitmaps.get(4));
            mTextureDataHandle5 = loadTexture(allBitmaps.get(5));
            // Get the link status.
